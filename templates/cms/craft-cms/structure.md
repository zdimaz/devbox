...
1. Компоненты → отдельные файлы `_components/`
2. Layouts → `_layout.twig` + embeds
3. Env vars → `.env`, не в конфиге
4. Project.yaml — для продакшена, в деве можно через админку
